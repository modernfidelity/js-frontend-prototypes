 ...
 *  INVENTORY MODULE
 *
 *  @file This component lists data from the backend for inventory + stock management
...
angular.module('project.uvl', ['ngRoute', 'angularUtils.directives.dirPagination'])
    ...
    .service('InventoryDataService', InventoryDataService)
...
InventoryDataService.$inject = ['$http', '$httpParamSerializer', '$httpParamSerializerJQLike'];

// Component Controller
InventoryController.$inject = ['InventoryDataService'];
 ...
 * @constructor
 */
function InventoryDataService($http, $httpParamSerializer) {

    // Setup endpoint var with local cors proxy otherwise you might not be able to return data
    var listingsAPI = "http://localhost/ims";
    ...
    function getVehicleData() {
        ...
        // Logger
        console.log("InventoryDataService.getVehicleData");
    ...
    function getListingsData() {
        ...
        // Logger
        console.log("InventoryDataService.getListingsData");
 ...
 * @constructor
 */
function InventoryController(InventoryDataService) {
    ...
    function getVehicleData() {
        ...
        content = InventoryDataService.getListingsData()
